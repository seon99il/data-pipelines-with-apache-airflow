...
def _get_ratings(start_date, end_date, batch_size=100):
    ...
    yield from _get_with_pagination(
        ...
        params={"start_date": start_date, "_end_date": end_date},
...
with DAG(
    ...
    fetch_ratings = PythonOperator(
        ...
        templates_dict={
            "start_date": "{{ds}}",
            "_end_date": "{{next_ds}}",
            "_output_path": "/opt/airflow/data/python/ratings/{{ds}}.json",
        },
    )
    ...
    rank_movies = PythonOperator(
        ...
        templates_dict={
            ...
            "_output_path": "/opt/airflow/data/python/rankings/{{ds}}.csv",
        },
    )
